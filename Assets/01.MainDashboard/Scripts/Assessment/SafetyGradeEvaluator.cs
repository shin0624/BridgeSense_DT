...
namespace BridgeSenseDT.Assessment
{
    ...
    /// <summary>RT-DETR + DeepLabV3+ 추론 결과를 평가용으로 환산한 결함 1건.</summary>
    public class DetectedDefect
    {
        public DefectType type;
        public float confidence;             // 검출 신뢰도 (0~1)
        public float maskAreaRatio;          // DeepLabV3+ 마스크 면적률 (0~1)
        ...
        // DeepLabV3+ 마스크에서 뽑아내며, 마스크 자체는 저장하지 않고 이 사각형만 남긴다.
