...
- BridgeSense DT는 T사용자가 업로드한 교량 외관 이미지에서 AI로 결함(균열, 박락, 백태, 누수, 철근 노출, 부식, 도장 박리 등)을 탐지·분할하고, 국토안전관리원 제3종시설물 안전등급 평가 방식에 따라 부재별/종합 안전등급을 산정한 후 3D 교량 모델과 대시보드 UI 위에 시각화하는 Unity 6 기반 교량 안전점검 플랫폼 SW입니다.
